    ...
    for (const place of basePlaces) {
      for (const suff of suffixes) {
        ...
        generated.push({
          ...
          seoTitle: `Best AC Repair & HVAC Services in ${name} | Prime Cool`,
          seoDesc: `Expert air conditioning repair, troubleshooting, and preventative maintenance in ${name}. Call Prime Cool for certified engineers and quick support.`,
          seoKeywords: `ac repair in ${name}, air conditioning service ${name}, hvac maintenance, ac installation ${name}, prime cool`
        });
      }
    }
  }
