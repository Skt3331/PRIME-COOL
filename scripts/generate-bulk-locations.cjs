  ...
  for (const dist of districts) {
    ...
    for (const place of basePlaces) {
      for (const suff of suffixes) {
        ...
        const lType =
          suff.includes("MIDC") || suff.includes("Industrial") ? "industrial" : "locality";
        ...
        generated.push({
          ...
          nearbyBusinesses: [`${place} Electricals`, `Sai Cooling Services`, `Balaji HVAC Care`],
          reviews: [
            {
...
console.log(
  `Successfully generated and added ${generated.length} locations to db.json! Total locations now: ${db.locations.length}`,
);
