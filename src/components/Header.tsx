...
import { Phone, Clock, Menu, X, AlertTriangle, Search, Zap, ChevronDown, Calculator, BookOpen, MapPin, Globe, Award, Settings, Thermometer, Wrench } from "lucide-react";
    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isMobileMenuOpen || isScrolled
          ? "backdrop-blur-2xl bg-[#09090f]/95 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.85)]"
          : "backdrop-blur-md bg-[#09090f]/80 border-b border-white/5"
      }`}
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        >
          <div className="relative flex items-center justify-center">
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#00c8ff]/40 to-[#0066ff]/30 blur-md group-hover:blur-lg transition-all duration-300" />
            <img
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-semibold tracking-widest text-[#00c8ff] uppercase mt-0.5 opacity-90">
              HVAC & Refrigeration
            </span>
          </div>
        </Link>
        ...
        <nav className="hidden xl:flex items-center gap-1.5 text-xs font-semibold">
          {/* Services Mega Menu (Residential & Commercial) */}
          <div className="relative group px-1">
            <Link
              to="/services"
              className="flex items-center gap-1 px-3 py-2 rounded-full text-slate-300 group-hover:text-white group-hover:bg-white/10 transition-all duration-200"
            >
              ...
              <div className="w-[560px] bg-[#0a0a0f]/98 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-2xl p-5 grid grid-cols-2 gap-6 relative overflow-hidden">
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-xs">
                    ...
                    <li><Link to="/services/ac-gas-charging" className="text-slate-400 hover:text-white transition">AC Gas Charging & Leak Detection (R32/R410A)</Link></li>
          ...
          >
            <Zap className="h-3.5 w-3.5" /> PCB Electronics
          </Link>
          ...
          <Link
            to="/portfolio"
            className="px-3 py-2 rounded-full text-slate-300 hover:text-white hover:bg-white/10 transition-all duration-200"
          >
            Case Studies
          </Link>
          <Link
        ...
        <div className="flex items-center gap-2 relative z-50 shrink-0">
          ...
          <button
            ...
            className="p-2.5 text-slate-300 hover:text-white hover:bg-white/10 rounded-full border border-white/10 transition-all duration-200 flex items-center gap-2 group"
